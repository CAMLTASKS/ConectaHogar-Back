...
function make_sugar_config(&$sugar_config)
{
    ...
    $sugar_config = array(
        ...
        'default_currency_name' => empty($default_currency_name) ? 'Pesos Colombianos' : $default_currency_name,
...
function get_sugar_config_defaults(): array
{
    ...
    $sugar_config_defaults = [
        ...
        'default_currency_name' => return_session_value_or_default('default_currency_name', 'Pesos Colombianos'),
