...
$dictionary["caml_apartamentos_caml_control_accesos_1"] = array (
  ...
  'table' => 'caml_apartamentos_caml_control_accesos_1_c',
  'fields' => 
  array (
    0 => 
    array (
    ...
    4 => 
    array (
      'name' => 'caml_apartamentos_caml_control_accesos_1caml_control_accesos_idb',
      'type' => 'varchar',
      'len' => 36,
    ),
  ),
  ...
  array (
    0 => 
    array (
      'name' => 'caml_apartamentos_caml_control_accesos_1spk',
      'type' => 'primary',
      'fields' => 
      array (
        0 => 'id',
    ...
    1 => 
    array (
      'name' => 'caml_apartamentos_caml_control_accesos_1_ida1',
      'type' => 'index',
      'fields' => 
      array (
        0 => 'caml_apartamentos_caml_control_accesos_1caml_apartamentos_ida',
      ),
    ),
    2 => 
    array (
      'name' => 'caml_apartamentos_caml_control_accesos_1_alt',
      'type' => 'alternate_key',
      'fields' => 
      array (
        0 => 'caml_apartamentos_caml_control_accesos_1caml_control_accesos_idb',
      ),
    ),
  ),
);