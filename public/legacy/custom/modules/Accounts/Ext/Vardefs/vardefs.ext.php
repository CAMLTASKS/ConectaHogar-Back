...
$dictionary["Account"]["fields"]["accounts_caml_apartamentos_1"] = array (
 ...
 // created: 2026-05-20 16:09:47
$dictionary['Account']['fields']['employees']['name']='employees';
...
$dictionary['Account']['fields']['employees']['unified_search']=true;
$dictionary['Account']['fields']['employees']['metadata']=array (
);

 

 // created: 2026-05-20 16:07:53
$dictionary['Account']['fields']['industry']['name']='industry';
$dictionary['Account']['fields']['industry']['inline_edit']=true;
$dictionary['Account']['fields']['industry']['options']='industry_dom';
...
$dictionary['Account']['fields']['industry']['unified_search']=true;
$dictionary['Account']['fields']['industry']['metadata']=array (
);
...
$dictionary['Account']['fields']['name']['type']='name';
...
$dictionary['Account']['fields']['localidad_c']['source']='non-db';
 ...
 // created: 2026-05-20 16:08:49
$dictionary['Account']['fields']['billing_address_street']['name']='billing_address_street';
$dictionary['Account']['fields']['billing_address_street']['len']='150';
...
$dictionary['Account']['fields']['billing_address_street']['metadata']=array (
);
...
$dictionary['Account']['fields']['ownership']['metadata']=array (
);
...
$dictionary['Account']['fields']['account_type']['options']='account_type_dom';
...
$dictionary['Account']['fields']['account_type']['unified_search']=true;
$dictionary['Account']['fields']['account_type']['metadata']=array (
);

 

 // created: 2026-05-20 16:09:02
$dictionary['Account']['fields']['billing_address_city']['name']='billing_address_city';
$dictionary['Account']['fields']['billing_address_city']['len']='100';
...
$dictionary['Account']['fields']['billing_address_city']['metadata']=array (
);
...
$dictionary['Account']['fields']['jjwg_areas_id1_c']['inline_edit']=1;
 ...
 // created: 2026-05-20 16:08:16
$dictionary['Account']['fields']['phone_office']['name']='phone_office';
$dictionary['Account']['fields']['phone_office']['len']='100';
$dictionary['Account']['fields']['phone_office']['audited']=true;
...
$dictionary['Account']['fields']['phone_office']['unified_search']=true;
$dictionary['Account']['fields']['phone_office']['metadata']=array (
);

 

 // created: 2026-05-20 16:08:30
$dictionary['Account']['fields']['phone_alternate']['name']='phone_alternate';
...
$dictionary['Account']['fields']['phone_alternate']['metadata']=array (
);
